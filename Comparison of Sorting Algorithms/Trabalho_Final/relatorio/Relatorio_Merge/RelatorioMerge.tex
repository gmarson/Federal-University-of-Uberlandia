...
\lstinputlisting[caption={MergeSort.py \label{arq:MergeSort}}]{../../Codigos/Merge/MergeSort.py}
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item Complexidade de tempo do método Merge Sort com mínimos quadrados disponível na lista de imagens ~\ref{fig:MergePlot3A}.
		\begin{figure}[!h]
			\centering
			\includegraphics[scale=0.6]{../imagens/Merge/merge_plot_3_aleatorio.png}
			\caption{Complexidade de tempo do método Merge Sort com mínimos quadrados (Vetor Aleatório) \label{fig:MergePlot3A}}
		\end{figure}
	...
	\item Para um vetor ordenado crescente
		\begin{enumerate}
			\item Complexidade de custo do método Merge Sort disponível na lista de imagens ~\ref{fig:MergePlot1OC}.
			\begin{figure}[!h]
				\centering
				\includegraphics[scale=0.6]{../imagens/Merge/merge_plot_1_ordenado_crescente.png}
				\caption{Complexidade de custo do método Merge Sort (Vetor Ordenado Crescente)\label{fig:MergePlot1OC}}
			\end{figure}
		...
		\item Para um vetor ordenado decrescente
				\begin{enumerate}
					...
					\item Complexidade de tempo do método Merge Sort com mínimos quadrados disponível na lista de imagens  ~\ref{fig:MergePlot3OD}.
					\begin{figure}[!h]
						\centering
						\includegraphics[scale=0.6]{../imagens/Merge/merge_plot_3_ordenado_decrescente.png}
						\caption{Complexidade de tempo do método Merge Sort com mínimos quadrados (Vetor Ordenado Decrescente) \label{fig:MergePlot3OD}}
					\end{figure}
			...
			\item Para um vetor parcialmente ordenado crescente
							\begin{enumerate}
								\item Complexidade de custo do método Merge Sort disponível na lista de imagens ~\ref{fig:MergePlot1POC}.
								\begin{figure}[!h]
									\centering
									\includegraphics[scale=0.6]{../imagens/Merge/merge_plot_1_parcialmente_ordenado_crescente.png}
									\caption{Complexidade de custo do método Merge Sort (Vetor Parcialmente Ordenado Crescente) \label{fig:MergePlot1POC}}
								\end{figure}
