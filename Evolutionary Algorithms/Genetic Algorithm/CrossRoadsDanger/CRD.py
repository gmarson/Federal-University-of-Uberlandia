...
class sendMore:
    ...
    def aptidao(self,f,filhos=None):
        ...
        for tupla in self.individuos:
            tupla[2] = (int(str(tupla[1][5]) + str(tupla[1][4]) + str(tupla[1][6]) + str(tupla[1][7]) + str(tupla[1][8]) + str(tupla[1][1]) ) )
            cross = int(str(tupla[1][0]) + str(tupla[1][1]) + str(tupla[1][2]) + str(tupla[1][3]) + str(tupla[1][3]) )
            roads = int(str(tupla[1][1]) + str(tupla[1][2]) + str(tupla[1][4]) + str(tupla[1][5]) + str(tupla[1][3]) )
            tupla[0] = 1000000 - abs( (cross+roads) - tupla[2])
            #print(tupla[1])
    ...
    def custom_fitness(self,f,filhos=None):
        ...
        for tupla in self.individuos:
            tupla[2] = str(tupla[1][5]) + str(tupla[1][4]) + str(tupla[1][6]) + str(tupla[1][7]) + str(tupla[1][8]) + str(tupla[1][1])
            cross = int(str(tupla[1][0]) + str(tupla[1][1]) + str(tupla[1][2]) + str(tupla[1][3]) + str(tupla[1][3]) )
            roads = int(str(tupla[1][1]) + str(tupla[1][2]) + str(tupla[1][4]) + str(tupla[1][5]) + str(tupla[1][3]) )
            nota = []
            candidato = str(cross + roads)
            ...
            tupla[0] = 100000000 - abs((cross+roads)-tupla[2]) * peso * tupla[0]            #print(str(tupla))
    ...
    def bestSolution(self,f):
        ...
        if save_tupla[0] == 100000000:
            #self.imprime(f)
            print("A melhor solucao tem nota "+str( save_tupla[0] ) + "\ncross: "+str(cross)+"\nroads: "+str(roads)+"\nPara um danger = "+str(save_tupla[2]) )
            #input()
            return True
