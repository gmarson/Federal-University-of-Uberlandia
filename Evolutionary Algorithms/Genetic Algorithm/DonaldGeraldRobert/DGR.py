...
class sendMore:
    ...
    def aptidao(self,f,filhos=None):
        ...
        for tupla in self.individuos:
            tupla[2] = (int(str(tupla[1][7]) + str(tupla[1][1]) + str(tupla[1][8]) + str(tupla[1][6]) + str(tupla[1][7]) + str(tupla[1][9])))
            donald = int(str(tupla[1][0]) + str(tupla[1][1]) + str(tupla[1][2]) + str(tupla[1][3]) + str(tupla[1][4]) + str(tupla[1][0]))
            gerald = int(str(tupla[1][5]) + str(tupla[1][6]) + str(tupla[1][7]) + str(tupla[1][3]) + str(tupla[1][4]) + str(tupla[1][0]))
            tupla[0] = 10000000 - abs( (donald+gerald) - tupla[2])
            #print(tupla[1])
            #print("donald: "+str(donald)+"\ngerald: "+str(gerald)+"\n"+"robert: "+str(tupla[2]) +"\nNota:"+str(tupla[0])+"\n" )
            #input()
    ...
    def custom_fitness(self,f,filhos=None):
        ...
        for tupla in self.individuos:
            tupla[2] = str(tupla[1][7]) + str(tupla[1][1]) + str(tupla[1][8]) + str(tupla[1][6]) + str(tupla[1][7]) + str(tupla[1][9])
            donald = int(str(tupla[1][0]) + str(tupla[1][1]) + str(tupla[1][2]) + str(tupla[1][3]) + str(tupla[1][4]) + str(tupla[1][0]))
            gerald = int(str(tupla[1][5]) + str(tupla[1][6]) + str(tupla[1][7]) + str(tupla[1][3]) + str(tupla[1][4]) + str(tupla[1][0]))
            nota = []
            candidato = str(donald + gerald)
            ...
            tupla[0] = 100000000 - abs((donald+gerald)-tupla[2]) * peso * tupla[0]            #print(str(tupla))
    ...
    def bestSolution(self,f):
        ...
        #f.write("\n\n-------------------------------------------\n\n")
        if save_tupla[0] == 10000000:
            #self.imprime(f)
            print("A melhor solucao tem nota "+str( save_tupla[0] ) + "\ndonald: "+str(donald)+"\ngerald: "+str(gerald)+"\nPara um robert = "+str(save_tupla[2]) )
            #input()
            return True
    ...
    def torneio(self,f):
        ...
        for i in range(0,Tcross,2):
            bestS1 , bestS2 = -99999999 , -99999999
...
if __name__ == '__main__':
    f = open("results_parametros.dat",mode='w',encoding='utf-8')
    #testes()
    #parametros_teste()
    Tp = 200
    Nger = 50
