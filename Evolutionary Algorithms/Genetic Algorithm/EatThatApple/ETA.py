...
class sendMore:
    ...
    def aptidao(self,f,filhos=None):
        ...
        for tupla in self.individuos:
            tupla[2] = (int(str(tupla[1][1]) + str(tupla[1][4]) + str(tupla[1][4]) + str(tupla[1][5]) + str(tupla[1][0]) ))
            eat = int(''.join(str(num) for num in tupla[1][:3]))
            that = (int(str(tupla[1][2]) + str(tupla[1][3]) + str(tupla[1][1]) + str(tupla[1][2])))
            tupla[0] = 100000 - abs( (eat +that) - tupla[2])
            #print("EAT: "+str(eat)+"\nTHAT: "+str(that)+"\n"+"APPLE: "+str(tupla[2]) +"\nNota:"+str(tupla[0])+"\n" )
    ...
    def custom_fitness(self,f,filhos=None):
        ...
        for tupla in self.individuos:
            tupla[2] = str(tupla[1][1]) + str(tupla[1][4]) + str(tupla[1][4]) + str(tupla[1][5]) + str(tupla[1][0])
            eat = int(''.join(str(num) for num in tupla[1][:3]))
            that = (int(str(tupla[1][2]) + str(tupla[1][3]) + str(tupla[1][1]) + str(tupla[1][2])))
            nota = []
            candidato = str(eat + that)
            ...
            tupla[0] = 100000000 -  peso *tupla[0]            #print(str(tupla))
    ...
    def bestSolution(self,f):
        ...
        #print("\n"+str(save_tupla))
        eat = int(''.join(str(num) for num in save_tupla[1][:3]))
        that = (int(str(save_tupla[1][2]) + str(save_tupla[1][3]) + str(save_tupla[1][1]) + str(save_tupla[1][2])))

        #print("A melhor solucao tem nota "+str( save_tupla[0] ) + "\nEAT: "+str(eat)+"\nTHAT: "+str(that)+"\nPara uma apple = "+str(save_tupla[2]) )
        #f.write("\nA melhor solução tem nota "+str( save_tupla[0] ) + "\nEAT: "+str(eat)+"\nTHAT: "+str(that)+"\nPara uma apple = "+str(save_tupla[2]) )
        #f.write("\n\n-------------------------------------------\n\n")
        if save_tupla[0] == 100000000:
            #self.imprime(f)
            #print("BEST: "+str(save_tupla))
            print("A melhor solucao tem nota "+str( save_tupla[0] ) + "\nEAT: "+str(eat)+"\nTHAT: "+str(that)+"\nPara uma apple = "+str(save_tupla[2]) )
            #input()
            return True
