...
class sendMore:
    ...
    def aptidao(self,f,filhos=None):
        ...
        for tupla in self.individuos:
            tupla[2] = int(str(tupla[1][1]) + str(tupla[1][2]) + str(tupla[1][4]) + str(tupla[1][5]) + str(tupla[1][4]) )
            cola = int( str(tupla[1][0]) +str(tupla[1][1]) + str(tupla[1][3]) + str(tupla[1][2]))
            coca = int(str(tupla[1][0]) + str(tupla[1][1]) + str(tupla[1][0]) + str(tupla[1][2]))
            tupla[0] = 100000 - abs( (coca +cola) - tupla[2])
            #print(str(tupla[1]))
            #print("COCA: "+str(coca)+"\nCOLA: "+str(cola)+"\n"+"OASIS: "+str(tupla[2]) +"\nNota:"+str(tupla[0])+"\n" )
    ...
    def custom_fitness(self,f,filhos=None):
        ...
        for tupla in self.individuos:
            tupla[2] = str(tupla[1][1]) + str(tupla[1][2]) + str(tupla[1][4]) + str(tupla[1][5]) + str(tupla[1][4])
            cola = int( str(tupla[1][0]) +str(tupla[1][1]) + str(tupla[1][3]) + str(tupla[1][2]))
            coca = int(str(tupla[1][0]) + str(tupla[1][1]) + str(tupla[1][0]) + str(tupla[1][2]))
            nota = []
            candidato = str(coca + cola)
            ...
            tupla[0] = 100000000 - abs((coca+cola)-tupla[2]) * peso *tupla[0]            #print(str(tupla))
    ...
    def bestSolution(self,f):
        ...
        if save_tupla[0] == 100000000:
            #self.imprime(f)
            print("A melhor solucao tem nota "+str( save_tupla[0] ) + "\nCOCA: "+str(coca)+"\nCOLA: "+str(cola)+"\nPara um oasis = "+str(save_tupla[2]) )
            return True
...
if __name__ == '__main__':
    f = open("custom.dat",mode='w',encoding='utf-8')
    #testes()
    Tp = 200
    Nger = 100
    Tcross = int(Tp * 0.8)
